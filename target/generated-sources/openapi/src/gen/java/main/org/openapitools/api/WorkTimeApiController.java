...
@Controller
@RequestMapping("${openapi.provaAzienda.base-path:}")
public class WorkTimeApiController implements WorkTimeApi {

    private final NativeWebRequest request;

    @Autowired
    public WorkTimeApiController(NativeWebRequest request) {
